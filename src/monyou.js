...
var $author$project$Types$Asanoha = {$: 'Asanoha'};
var $author$project$Types$CircleMode = {$: 'CircleMode'};
...
var $author$project$Monyou$init = {
	...
	lineColorPicker: $simonh1000$elm_colorpicker$ColorPicker$empty,
	monyou: $author$project$Types$Asanoha,
	newShape: $elm$core$Maybe$Nothing,
	shapes: _List_Nil,
	unit: 70
};
...
var $author$project$Types$Circle = function (a) {
	return {$: 'Circle', a: a};
};
var $author$project$Types$CircleData = F5(
	function (cx, cy, r, fillColor, stroke) {
		return {cx: cx, cy: cy, fillColor: fillColor, r: r, stroke: stroke};
	});
var $author$project$Types$Oresen = function (a) {
	return {$: 'Oresen', a: a};
};
var $author$project$Types$OresenData = F2(
	function (points, stroke) {
		return {points: points, stroke: stroke};
	});
var $author$project$Types$Point = F2(
	function (x, y) {
		return {x: x, y: y};
	});
var $author$project$Types$Polygon = function (a) {
	return {$: 'Polygon', a: a};
};
var $author$project$Types$PolygonData = F3(
...
var $author$project$Monyou$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Down':
				var pos = msg.a;
				...
				switch (_v1.$) {
					case 'CircleMode':
						var dummy = A2($elm$core$Debug$log, 'down', pos);
						return _Utils_update(
							model,
							{
								newShape: $elm$core$Maybe$Just(
									$author$project$Types$Circle(
										A5(
											$author$project$Types$CircleData,
											(pos.x / model.unit) / 4,
											(pos.y / model.unit) / 4,
											0,
											$avh4$elm_color$Color$toCssString(model.fillColor),
											$avh4$elm_color$Color$toCssString(model.lineColor))))
							});
					case 'LineMode':
						return model;
					default:
			...
			case 'Up':
				...
				switch (_v2.$) {
					case 'CircleMode':
						var newlyAdded = function () {
							var _v3 = model.newShape;
							if (_v3.$ === 'Just') {
								var shape = _v3.a;
								return _List_fromArray(
									[shape]);
						...
						var dummy = A2($elm$core$Debug$log, 'up', pos);
						return _Utils_update(
							model,
							{
								newShape: $elm$core$Maybe$Nothing,
								shapes: _Utils_ap(model.shapes, newlyAdded)
							});
					case 'LineMode':
						return model;
					default:
			...
			case 'Move':
				...
				switch (_v4.$) {
					case 'CircleMode':
						var _v5 = model.newShape;
						if ((_v5.$ === 'Just') && (_v5.a.$ === 'Circle')) {
							var circledata = _v5.a.a;
							var newR = $elm$core$Basics$sqrt(
								A2($elm$core$Basics$pow, circledata.cx - (pos.x / (4 * model.unit)), 2) + A2($elm$core$Basics$pow, circledata.cy - (pos.y / (4 * model.unit)), 2));
							return _Utils_update(
								model,
								{
									newShape: $elm$core$Maybe$Just(
					...
					case 'LineMode':
						var _v6 = model.newShape;
						if ((_v6.$ === 'Just') && (_v6.a.$ === 'Oresen')) {
							var oresen = _v6.a.a;
							var newEndPoint = A2($author$project$Types$Point, pos.x / (4 * model.unit), pos.y / (4 * model.unit));
							return _Utils_update(
								model,
								{
									newShape: $elm$core$Maybe$Just(
										$author$project$Types$Oresen(
											_Utils_update(
												oresen,
												{
													points: _Utils_ap(
														A2(
															$elm$core$List$take,
															$elm$core$List$length(oresen.points) - 1,
															oresen.points),
														_List_fromArray(
															[newEndPoint]))
												})))
					...
					default:
						var _v7 = model.newShape;
						if ((_v7.$ === 'Just') && (_v7.a.$ === 'Polygon')) {
							var polygon = _v7.a.a;
							var newEndPoint = A2($author$project$Types$Point, pos.x / (4 * model.unit), pos.y / (4 * model.unit));
							return _Utils_update(
								model,
											...
											_Utils_update(
												polygon,
												{
													points: _Utils_ap(
														A2(
															$elm$core$List$take,
															$elm$core$List$length(polygon.points) - 1,
															polygon.points),
														_List_fromArray(
															[newEndPoint]))
												})))
			...
			case 'Click':
				var pos = msg.a;
				var _v8 = model.editMode;
				switch (_v8.$) {
					case 'CircleMode':
						return model;
					case 'LineMode':
						var _v9 = model.newShape;
						if (_v9.$ === 'Nothing') {
							return A2(
								$elm$core$Debug$log,
								'clicked',
								_Utils_update(
									model,
									{
										newShape: $elm$core$Maybe$Just(
											$author$project$Types$Oresen(
												A2(
													$author$project$Types$OresenData,
													_List_fromArray(
														[
															A2($author$project$Types$Point, (pos.x / model.unit) / 4, (pos.y / model.unit) / 4)
														]),
													$avh4$elm_color$Color$toCssString(model.lineColor))))
									}));
						} else {
							...
							return _Utils_update(
								model,
								{
									newShape: $elm$core$Maybe$Just(
										$author$project$Types$Polygon(
											A3(
												$author$project$Types$PolygonData,
												_List_fromArray(
													[
														A2($author$project$Types$Point, (pos.x / model.unit) / 4, (pos.y / model.unit) / 4)
													]),
			...
			case 'DoubleClick':
				var _v11 = model.editMode;
				switch (_v11.$) {
					case 'CircleMode':
						return model;
					case 'LineMode':
						var _v12 = model.newShape;
						if (_v12.$ === 'Just') {
							var oresen = _v12.a;
							return _Utils_update(
								model,
			...
			case 'Crystal':
				var crystalType = msg.a;
				return _Utils_update(
					model,
					{monyou: crystalType});
			case 'ModeSelected':
				var editMode = msg.a;
				var dummy = A2($elm$core$Debug$log, 'mode', editMode);
				return _Utils_update(
					model,
					{editMode: editMode});
			case 'FillColorPicked':
				var cmsg = msg.a;
				var _v14 = A3($simonh1000$elm_colorpicker$ColorPicker$update, cmsg, model.fillColor, model.fillColorPicker);
				var m = _v14.a;
				var col = _v14.b;
				return _Utils_update(
					model,
					{
						fillColor: A2($elm$core$Maybe$withDefault, model.fillColor, col),
						fillColorPicker: m
					});
			case 'LineColorPicked':
				var cmsg = msg.a;
				var _v15 = A3($simonh1000$elm_colorpicker$ColorPicker$update, cmsg, model.lineColor, model.lineColorPicker);
				var m = _v15.a;
				var col = _v15.b;
				return _Utils_update(
					model,
					{
						lineColor: A2($elm$core$Maybe$withDefault, model.lineColor, col),
						lineColorPicker: m
					});
			case 'DeleteAll':
				return _Utils_update(
...
var $author$project$Monyou$color = {
...
var $author$project$Types$DoubleClick = {$: 'DoubleClick'};
...
var $author$project$Asanoha$fundPath = function (size) {
	return A2(
		$elm$svg$Svg$path,
		_List_fromArray(
			[
				$elm$svg$Svg$Attributes$d(
				'M 0 0 l ' + ($elm$core$String$fromFloat(size) + (' ' + ($elm$core$String$fromFloat(
					(1 / $elm$core$Basics$sqrt(3)) * size) + (' l 0' + ($elm$core$String$fromFloat(
					((-1) / $elm$core$Basics$sqrt(3)) * size) + (' l ' + ($elm$core$String$fromFloat(-size) + ' 0 z')))))))),
				$elm$svg$Svg$Attributes$stroke('red'),
				$elm$svg$Svg$Attributes$fill('gray')
			]),
		_List_Nil);
};
var $author$project$Ichimatsu$fundPath = function (size) {
	return A2(
		$elm$svg$Svg$path,
		_List_fromArray(
			[
				$elm$svg$Svg$Attributes$d(
				'M 0 0 l ' + ($elm$core$String$fromFloat(size) + (' ' + ($elm$core$String$fromFloat(size) + (' l ' + ($elm$core$String$fromFloat(-size) + ' 0 z')))))),
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$svg$Svg$Attributes$d(
				'M 0 0 l ' + ($elm$core$String$fromFloat(size) + (' ' + ($elm$core$String$fromFloat(
					size / $elm$core$Basics$sqrt(3)) + (' l ' + ($elm$core$String$fromFloat(size) + (' ' + ($elm$core$String$fromFloat(
					(-size) / $elm$core$Basics$sqrt(3)) + ' z ')))))))),
				$elm$svg$Svg$Attributes$stroke('red'),
				$elm$svg$Svg$Attributes$fill('gray')
			]),
		_List_Nil);
...
var $author$project$PrimitivesView$circleView = F3(
	function (id, circle, unit) {
		return A2(
			$elm$svg$Svg$circle,
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$cx(
					$elm$core$String$fromFloat(unit * circle.cx)),
					$elm$svg$Svg$Attributes$cy(
					$elm$core$String$fromFloat(unit * circle.cy)),
					$elm$svg$Svg$Attributes$r(
					$elm$core$String$fromFloat(unit * circle.r)),
					$elm$svg$Svg$Attributes$fill(circle.fillColor),
					$elm$svg$Svg$Attributes$stroke(circle.stroke),
					$elm$svg$Svg$Attributes$clipPath('url(#cell' + (id + ')'))
				]),
			_List_Nil);
	});
var $author$project$PrimitivesView$oresenView = F3(
	function (id, oresen, unit) {
		var pathString = A3(
			$elm$core$List$foldl,
			F2(
				function (point, str) {
					return str + (((str === '') ? 'M ' : 'L ') + ($elm$core$String$fromFloat(unit * point.x) + (' ' + ($elm$core$String$fromFloat(unit * point.y) + ' '))));
				}),
			'',
			oresen.points);
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$svg$Svg$Attributes$stroke(oresen.stroke),
					$elm$svg$Svg$Attributes$clipPath('url(#cell' + (id + ')'))
				]),
			_List_Nil);
	});
var $author$project$PrimitivesView$polygonView = F3(
	function (id, polygon, unit) {
		var pathString = A3(
			$elm$core$List$foldl,
			F2(
				function (point, str) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$d(pathString + ' Z '),
					$elm$svg$Svg$Attributes$fill(polygon.fillColor),
					$elm$svg$Svg$Attributes$stroke(polygon.stroke),
					$elm$svg$Svg$Attributes$clipPath('url(#cell' + (id + ')'))
				]),
			_List_Nil);
	});
var $author$project$PrimitivesView$shapeView = F3(
	function (shape, id, unit) {
		switch (shape.$) {
			case 'Oresen':
				var oresen = shape.a;
				return A3($author$project$PrimitivesView$oresenView, id, oresen, unit * 2);
			case 'Polygon':
				var polygon = shape.a;
				return A3($author$project$PrimitivesView$polygonView, id, polygon, unit * 2);
			default:
				var circle = shape.a;
				return A3($author$project$PrimitivesView$circleView, id, circle, unit * 2);
		}
	});
		...
		A2(
			...
			_List_fromArray(
				[
					...
					A2($elm$core$Basics$composeR, relativePos, $author$project$Types$Down)),
					$mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$onUp(
					A2($elm$core$Basics$composeR, relativePos, $author$project$Types$Up)),
					$mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$onMove(
					A2($elm$core$Basics$composeR, relativePos, $author$project$Types$Move)),
					$mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$onClick(
					A2($elm$core$Basics$composeR, mousePos, $author$project$Types$Click)),
					$mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$onDoubleClick(
					function (ev) {
						return $author$project$Types$DoubleClick;
					})
				]),
			_List_fromArray(
				[
					...
					_Utils_ap(
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$svg$Svg$Attributes$id('cell0')
									]),
								_List_fromArray(
									[
										function () {
						...
						_Utils_ap(
							A2(
								$elm$core$List$map,
								function (shape) {
									return A3($author$project$PrimitivesView$shapeView, shape, '0', 2 * model.unit);
								},
								model.shapes),
							function () {
								var _v1 = model.newShape;
								if (_v1.$ === 'Just') {
									var shape = _v1.a;
									return _List_fromArray(
										[
											A3($author$project$PrimitivesView$shapeView, shape, '0', 2 * model.unit)
										]);
								} else {
									return _List_Nil;
								}
...
var $author$project$Asanoha$fundD = F2(
	function (id, model) {
		return A2(
			$elm$svg$Svg$g,
			_List_Nil,
			_Utils_ap(
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Asanoha$fundPath(model.unit * 0.5)
							]))
					]),
				_Utils_ap(
					_List_fromArray(
...
var $author$project$Asanoha$rhombus = F4(
	function (model, s, t, unit) {
		var prefix = $elm$core$String$fromInt(s) + ('-' + $elm$core$String$fromInt(t));
		var oy = ((unit * $elm$core$Basics$sqrt(3)) / 2) * t;
		var ox = (unit * (s + (t / 2))) + (2 * model.unit);
		return A2(
			$elm$svg$Svg$g,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					A2($author$project$Asanoha$fundD, prefix + 'a', model),
					A2(
					$elm$svg$Svg$g,
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$transform(
							'matrix(-1,0,0,1,' + ($elm$core$String$fromFloat(model.unit) + ',0)'))
						]),
					_List_fromArray(
						[
							A2($author$project$Asanoha$fundD, prefix + 'b', model)
						])),
					A2(
					$elm$svg$Svg$g,
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$transform('rotate(60)')
						]),
					_List_fromArray(
						[
							A2($author$project$Asanoha$fundD, prefix + 'c', model),
							A2(
							$elm$svg$Svg$g,
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									A2($author$project$Asanoha$fundD, prefix + 'd', model)
								]))
						])),
					A2(
					$elm$svg$Svg$g,
					...
					_List_fromArray(
						[
							A2($author$project$Asanoha$fundD, prefix + 'e', model),
							A2(
							$elm$svg$Svg$g,
							_List_fromArray(
								[
					...
					_List_fromArray(
						[
							A2($author$project$Asanoha$fundD, prefix + 'f', model),
							A2(
							$elm$svg$Svg$g,
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									A2($author$project$Asanoha$fundD, prefix + 'g', model)
								]))
						])),
					A2(
					$elm$svg$Svg$g,
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$transform(' rotate(60) scale(1,-1)')
						]),
					_List_fromArray(
						[
							A2($author$project$Asanoha$fundD, prefix + 'h', model),
							A2(
							$elm$svg$Svg$g,
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									A2($author$project$Asanoha$fundD, prefix + 'i', model)
								]))
						])),
					A2(
					$elm$svg$Svg$g,
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$transform(' rotate(120) scale(1,-1)')
						]),
					_List_fromArray(
						[
							A2($author$project$Asanoha$fundD, prefix + 'j', model),
							A2(
							$elm$svg$Svg$g,
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									A2($author$project$Asanoha$fundD, prefix + 'k', model)
								]))
						]))
				]));
	});
var $author$project$Asanoha$rhombi = function (model) {
	var n = 17;
	return A2(
		$elm$core$List$map,
		function (i) {
			...
			var s = ((i / n) | 0) - ((n / 2) | 0);
			return A4($author$project$Asanoha$rhombus, model, s, t, model.unit);
		},
		A2($elm$core$List$range, 0, (n * n) - 1));
};
var $author$project$Ichimatsu$fundD = F2(
	function (id, model) {
		return A2(
			$elm$svg$Svg$g,
			_List_Nil,
			_Utils_ap(
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Ichimatsu$fundPath(model.unit * 0.5)
							]))
					]),
				_Utils_ap(
					_List_fromArray(
...
var $author$project$Ichimatsu$rhombus = F4(
	function (model, s, t, unit) {
		var prefix = $elm$core$String$fromInt(s) + ('-' + $elm$core$String$fromInt(t));
		var oy = unit * t;
		var ox = unit * (s + 5);
		return A2(
			...
			_List_fromArray(
				[
					A2($author$project$Ichimatsu$fundD, prefix + 'a', model),
					A2(
					$elm$svg$Svg$g,
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$transform('matrix(-1,0,0,1,' + '0,0)')
						]),
					_List_fromArray(
						[
							A2($author$project$Ichimatsu$fundD, prefix + 'b', model)
						])),
					A2(
					$elm$svg$Svg$g,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$transform('rotate(180)')
						]),
					_List_fromArray(
						[
							A2($author$project$Ichimatsu$fundD, prefix + 'a', model)
					...
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$transform('rotate(270)')
						]),
					_List_fromArray(
						[
							A2($author$project$Ichimatsu$fundD, prefix + 'a', model)
					...
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$transform('matrix(0,1,1,0,0,0)')
						]),
					_List_fromArray(
						[
							A2($author$project$Ichimatsu$fundD, prefix + 'b', model)
					...
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$transform('matrix(0,1,1,0,0,0)rotate(180)')
						]),
					_List_fromArray(
						[
							A2($author$project$Ichimatsu$fundD, prefix + 'b', model)
...
var $author$project$Ichimatsu$rhombi = function (model) {
	var n = 14;
	return A2(
		$elm$core$List$map,
		function (i) {
			var t = A2($elm$core$Basics$modBy, n, i);
			var s = ((i / n) | 0) - ((n / 2) | 0);
			return A4($author$project$Ichimatsu$rhombus, model, s, t, model.unit);
		},
		A2($elm$core$List$range, 0, (n * n) - 1));
};
			...
			_Utils_ap(
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Rokkaku$fundPath(model.unit * 0.5)
							]))
					]),
				_Utils_ap(
					_List_fromArray(
...
var $author$project$Rokkaku$rhombus = F4(
	function (model, s, t, unit) {
		var prefix = $elm$core$String$fromInt(s) + ('-' + $elm$core$String$fromInt(t));
		var oy = ((unit * $elm$core$Basics$sqrt(3)) / 2) * t;
		var ox = (unit * (s + (t / 2))) + (2.5 * model.unit);
		return A2(
			$elm$svg$Svg$g,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					A2($author$project$Rokkaku$fundD, prefix + 'a', model),
					A2(
					$elm$svg$Svg$g,
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$transform(
							'translate(' + ($elm$core$String$fromInt((unit / 2) | 0) + (' ' + ($elm$core$String$fromFloat(
								(0.5 / $elm$core$Basics$sqrt(3)) * model.unit) + (')' + ('rotate(120) translate(' + ($elm$core$String$fromInt(((-unit) / 2) | 0) + (' ' + ($elm$core$String$fromFloat(
								((-0.5) / $elm$core$Basics$sqrt(3)) * model.unit) + ')')))))))))
						]),
					_List_fromArray(
						[
							A2($author$project$Rokkaku$fundD, prefix + 'c', model)
						])),
					A2(
					$elm$svg$Svg$g,
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$transform(
							'translate(' + ($elm$core$String$fromInt((unit / 2) | 0) + (' ' + ($elm$core$String$fromFloat(
								(0.5 / $elm$core$Basics$sqrt(3)) * model.unit) + (')' + ('rotate(240) translate(' + ($elm$core$String$fromInt(((-unit) / 2) | 0) + (' ' + ($elm$core$String$fromFloat(
								((-0.5) / $elm$core$Basics$sqrt(3)) * model.unit) + ')')))))))))
						]),
					_List_fromArray(
						[
							A2($author$project$Rokkaku$fundD, prefix + 'e', model)
						])),
					A2(
					$elm$svg$Svg$g,
					_List_fromArray(
...
var $author$project$Rokkaku$rhombi = function (model) {
	var n = 16;
	return A2(
		$elm$core$List$map,
		function (i) {
			var t = A2($elm$core$Basics$modBy, n, i);
			var s = ((i / n) | 0) - ((n / 2) | 0);
			return A4($author$project$Rokkaku$rhombus, model, s, t, model.unit);
		},
		A2($elm$core$List$range, 0, (n * n) - 1));
};
var $author$project$Monyou$screenSvg = function (model) {
	return A2(
		$elm$svg$Svg$svg,
		_List_fromArray(
			[
...
var $author$project$Monyou$screen = function (model) {
	return $mdgriffith$elm_ui$Element$html(
		$author$project$Monyou$screenSvg(model));
};
...
var $author$project$Types$Crystal = function (a) {
	return {$: 'Crystal', a: a};
};
...
var $author$project$Types$Ichimatsu = {$: 'Ichimatsu'};
var $author$project$Types$LineColorPicked = function (a) {
	return {$: 'LineColorPicked', a: a};
};
var $author$project$Types$LineMode = {$: 'LineMode'};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					{
						blur: 10,
						color: $author$project$Monyou$color.lightGrey,
...
var $author$project$Monyou$tools = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Border$color($author$project$Monyou$color.blue),
				$mdgriffith$elm_ui$Element$Border$width(2),
				$mdgriffith$elm_ui$Element$Background$color($author$project$Monyou$color.lightGrey),
...
var $author$project$Monyou$view = function (model) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$Monyou$tools(model),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_Nil,
					$author$project$Editor$editor(model)),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_Nil,
					$author$project$Monyou$screen(model))
				])));
};
var $author$project$Monyou$main = $elm$browser$Browser$sandbox(
	{init: $author$project$Monyou$init, update: $author$project$Monyou$update, view: $author$project$Monyou$view});
_Platform_export({'Monyou':{'init':$author$project$Monyou$main(
